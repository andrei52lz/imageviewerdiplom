...
Проект разработан пользователем GitHub [`Andrei52Lz`](https://github.com/Andrei52Lz).

## Назначение проекта

VisionKit создан как учебный и прикладной инструмент для демонстрации, визуальной проверки и количественной оценки результатов детекции объектов на изображениях в формате KITTI/YOLO.

Проект может использоваться для:

- демонстрации работы моделей детекции объектов;
- сравнения Ground Truth и предсказаний модели;
- проверки качества разметки и predictions;
- расчета основных метрик object detection;
- подготовки материалов для исследовательской или учебной работы.
...
Проект распространяется по лицензии MIT. Подробные условия указаны в файле [`LICENSE`](LICENSE).
